...
import infiapp.envento.photorecoverynew.activity.VideoActivity;
import infiapp.envento.photorecoverynew.view.SquareImageView;

public class SectionListDataAdapterForVideo
        extends RecyclerView.Adapter<SectionListDataAdapterForVideo.SingleItemRowHolder> {
    ...
    public SectionListDataAdapterForVideo(Context context, ArrayList<VideoModel> itemsList, int mPostion,
            Activity aaa) {
