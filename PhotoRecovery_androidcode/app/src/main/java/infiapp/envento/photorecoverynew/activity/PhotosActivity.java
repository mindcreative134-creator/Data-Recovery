...
import infiapp.envento.photorecoverynew.adapter.PhotoAdapter;
import infiapp.envento.photorecoverynew.task.RecoverPhotosAsyncTask;

import static infiapp.envento.photorecoverynew.utills.Utils.mAlbumPhotos;
import static infiapp.envento.photorecoverynew.utills.Utils.mHiddenFiles;
...
public class PhotosActivity extends AppCompatActivity {
    ...
    private void gotonext() {
        ...
        if (status.equals("restore")) {
            ...
            if (tempList.size() == 0) {
                Toast.makeText(PhotosActivity.this, "Cannot restore, all items are unchecked!", Toast.LENGTH_LONG)
                        .show();
            } else {

                mRecoverPhotosAsyncTask = new RecoverPhotosAsyncTask(PhotosActivity.this, adapter.getSelectedItem(),
                        new RecoverPhotosAsyncTask.OnRestoreListener() {
                            @Override
